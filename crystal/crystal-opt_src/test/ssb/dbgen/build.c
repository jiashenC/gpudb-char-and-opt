...
We reduce it to 22 by limiting to a concatena�tion of two colors (see [TPC-H],
pg 94).
We also add a new column named P_COLOR that could be used in queries where
currently a
...
season seasons[] = {{"Christmas", 1, 11, 31, 12},
                    ...
                    {"Spring", 1, 4, 30, 4},
                    {"Fall", 1, 9, 31, 10}};
holiday holidays[] = {{"Christmas", 12, 24}, {"New Years Day", 1, 1},
                      {"holiday1", 2, 20},   {"Easter Day", 4, 20},
                      {"holiday2", 5, 20},   {"holiday3", 7, 20},
                      {"holiday4", 8, 20},   {"holiday5", 9, 20},
 ...
 *then convert the final numeric date time to tm structure, and thus extract
 *other field
